...
export const insights: Array<Insight> = [
  {
    slug: 'etims-readiness-kenya-2026',
    title:
      'eTIMS is now the audit trail. Most sales ledgers still do not reconcile to it.',
    type: 'Whitepaper',
    summary:
      'A review of 60 Kenyan taxpayer files, and the four reconciliation failures between the sales ledger and eTIMS that appear in almost all of them.',
  ...
  {
    slug: 'payroll-levies-reconciliation-gap',
    title:
      'The payroll levies are a reconciliation problem before they are a rate problem',
    type: 'Article',
    summary:
      'Employers that fell behind on SHA and the Housing Levy did not misread the rates. Their payroll never reconciled to the statutory portals.',
  ...
  {
    slug: 'internal-control-findings-that-recur',
    title:
      'Five internal control findings that recur in every institution we audit',
    type: 'Article',
    summary:
      'Segregation of duties, approval evidence, and three other controls that fail for structural rather than technical reasons.',
    publishedAt: '2026-05-28',
    readingMinutes: 8,
    author: 'Brian Kiptoo',
    authorRole: 'Director, Technology Assurance',
    photo: photos.dataCentre,
    topics: ['Internal Audit', 'Controls', 'Compliance'],
    access: 'open',
  },
  {
    slug: 'data-protection-readiness-east-africa',
    title: 'Data protection readiness in East Africa: a baseline study',
    type: 'Whitepaper',
    summary:
      'How prepared large institutions in the region are for privacy compliance — lawful basis, processing records and breach response — based on a survey of 120 entities.',
    publishedAt: '2026-05-09',
    readingMinutes: 22,
    author: 'Fatuma Abdi',
    authorRole: 'Director, Data Protection',
    photo: photos.dataCentre,
    topics: ['Data Protection', 'Privacy', 'Research'],
    access: 'open',
    pages: 46,
  },
  {
